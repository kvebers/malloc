...
# define SMALL (1152 - sizeof(chunk_t))
...
#define TINYSIZE (GETMEMORYSIZE(ALLOC_COUNT * (TINY + sizeof(chunk_t)), 4096))
#define SMALLSIZE (GETMEMORYSIZE(ALLOC_COUNT * (SMALL + sizeof(chunk_t)), 4096))
#define DEBUG 0
